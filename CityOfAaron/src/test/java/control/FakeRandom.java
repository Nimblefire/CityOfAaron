...
/**
 * This class provides a way for Random to be tested but still controlled. 
 * It overrides nextInt(int bound) to return a predetermined value.
 */
public class FakeRandom extends Random {
    ...
    /**
     * Returns the next predetermined value from the list, or -1 
     * if there are no more predetermined values to be returned.
     */
    @Override
